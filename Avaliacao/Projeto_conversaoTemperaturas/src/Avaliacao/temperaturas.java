...
public class temperaturas {
	...
	public static void main(String[] args) {
		...
		if(quant <= 0) {
			System.out.println("Não há nenhuma temperatura para transformar.");
		} else {
		...
		System.out.printf("A média das temperaturas iniciais é %.2f.", mediaI);
		double mediaT = cont2/quant;
		System.out.printf("\nA média das temperaturas transformadas é %.2f.", mediaT);
